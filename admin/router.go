...
func Route(cfg *config.Config, db *sql.DB, tmpl *template.Template) http.Handler {
    ...
    mux.HandleFunc("GET  /countries/{id}/region/{region_id}",           regionsEdit(cfg, db, tmpl))
    mux.HandleFunc("POST /countries/{id}/region/{region_id}",           regionsEditPost(cfg, db, tmpl))
    mux.HandleFunc("POST /countries/{id}/region/{region_id}/delete",    regionsDeletePost(cfg, db, tmpl))
